...
namespace JillelaWeek6.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public EnrollmentsController(HogwartsContext context)
        {
            _context = context;
        }
        ...
        {
            var hogwartsContext = _context.Enrollments.Include(e => e.Course).Include(e => e.Student);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'HogwartsContext.Enrollments'  is null.");
            }
            var enrollment = await _context.Enrollments.FindAsync(id);
            if (enrollment != null)
            {
